...
url_pdf: 'https://aclanthology.org/2023.acl-long.550.pdf'
url_code: 'https://github.com/jiangjiechen/uncommongen'
# url_dataset: ''
# url_poster: ''
# url_project: ''
# url_slides: ''
...
<!-- {{% callout note %}}
Click the _Cite_ button above to demo the feature to enable visitors to import llm metadata into their reference management software.
{{% /callout %}}
